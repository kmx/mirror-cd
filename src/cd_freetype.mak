...
SRC  := \
  autofit/afpic.c autofit/autofit.c bdf/bdf.c cff/cff.c base/basepic.c \
  base/ftadvanc.c base/ftcid.c base/ftfstype.c base/ftpic.c base/ftsnames.c cache/ftcache.c \
